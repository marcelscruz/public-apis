...
+| [MusicGPT](https://docs.musicgpt.com/api-documentation/index/introduction) | AI Music Generator with text-to-speech, voice changer, remix & 20+ music features. | `apiKey` | Yes | Yes |
