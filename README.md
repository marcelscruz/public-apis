...
| [FreeCustom.Email](https://freecustom.email/api/docs/quickstart) | Disposable email inboxes with OTP extraction and real-time WebSocket events | `apiKey` | Yes | Yes |
