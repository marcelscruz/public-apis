...
| [Delta Lake](https://docs.delta.io/latest/delta-apidoc.html) | An open-source storage framework that enables building a Lakehouse architecture with compute engines including Spark, PrestoDB, Flink, Trino, and Hive and APIs | No | No | Unknown |
