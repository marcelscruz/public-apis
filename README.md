...
| [Kiprio Contract Extract](https://kiprio.com/v1/contract-extract/) | Extract parties, dates, payment terms, governing law, and dispute resolution clauses from raw contract text as structured JSON (BYOK — bring your own Anthropic key) | `apiKey` | Yes | Yes |
