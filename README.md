...
| [ToolPipe](https://assessing-scoop-authorities-sheet.trycloudflare.com) | 112+ free developer utility APIs and MCP server for JSON, PDF, QR, hash, UUID, DNS, regex, JWT, IP lookup, and more | `apiKey` | Yes | Yes |
