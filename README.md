...
| [Chrome Built-in AI](https://developer.chrome.com/docs/ai/built-in/) | Client-side APIs (e.g. Translation, Summarization, Proofreading) powered by Gemini Nano models integrated into Chrome | No | Yes | Yes |
