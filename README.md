...
| [MentionsAPI](https://mentionsapi.com/docs/api/check) | Check brand mentions, ranks and citations across AI search surfaces (ChatGPT, Claude, Gemini, Perplexity, AI Overviews) | `apiKey` | Unknown |
