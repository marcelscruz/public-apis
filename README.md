...
| [ToolPipe](https://toolpipe.dev) | Free developer utility APIs with 70+ endpoints for QR codes, JSON formatting, text analysis, PDF processing, UUID generation, and more | No | Yes | Yes |
