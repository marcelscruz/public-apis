...
| [Svensk Skatte-API](https://skatteapi.gracestack.se) | Swedish tax calculations: ISK, VAT, income tax, employer contributions — CORS enabled (all origins) | `apiKey` | Yes | Yes |
