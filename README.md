...
| [DataHarvest API](https://ouroboros-production-c0d7.up.railway.app) | Web scraping API — Google SERP, contact extraction, Google Maps, and Amazon product data | `apiKey` | Yes | Yes |
