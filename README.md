...
| [License Verify](https://rapidapi.com/lulzasaur/api/license-verify) | Verify contractor and nurse licenses across CA, TX, FL, NY with real-time status checks | `apiKey` | Yes | Unknown |
